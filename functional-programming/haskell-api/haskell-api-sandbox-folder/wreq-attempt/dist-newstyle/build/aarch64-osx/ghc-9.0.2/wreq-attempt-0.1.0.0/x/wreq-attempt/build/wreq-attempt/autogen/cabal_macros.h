...
/* package wreq-attempt-0.1.0.0 */
#ifndef VERSION_wreq_attempt
#define VERSION_wreq_attempt "0.1.0.0"
#endif /* VERSION_wreq_attempt */
#ifndef MIN_VERSION_wreq_attempt
#define MIN_VERSION_wreq_attempt(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_wreq_attempt */
...
#define CURRENT_COMPONENT_ID "wreq-attempt-0.1.0.0-inplace-wreq-attempt"
