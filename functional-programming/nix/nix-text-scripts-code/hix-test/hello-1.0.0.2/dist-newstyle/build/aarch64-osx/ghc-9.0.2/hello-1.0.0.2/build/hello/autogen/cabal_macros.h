...
/* package hello-1.0.0.2 */
#ifndef VERSION_hello
#define VERSION_hello "1.0.0.2"
#endif /* VERSION_hello */
#ifndef MIN_VERSION_hello
#define MIN_VERSION_hello(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_hello */
...
#define CURRENT_COMPONENT_ID "hello-1.0.0.2-inplace-hello"
